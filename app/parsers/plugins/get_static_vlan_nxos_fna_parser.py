...
class GetStaticVlanNxosFnaParser(BaseParser[InterfaceVlanData]):
    """
    Parser for get_static_vlan_nxos_fna API response.
    ...
    command = "get_static_vlan_nxos_fna"
...
# Register parser
parser_registry.register(GetStaticVlanNxosFnaParser())