...
class GetTransceiverIosFnaParser(BaseParser):
    """
    Parser for get_transceiver_ios_fna API response.
    ...
    Example after filling in:
        ...
        class GetTransceiverIosFnaParser(BaseParser[FanStatusData]):
            device_type = DeviceType.HPE
            command = "get_transceiver_ios_fna"
...
# Register parser
parser_registry.register(GetTransceiverIosFnaParser())