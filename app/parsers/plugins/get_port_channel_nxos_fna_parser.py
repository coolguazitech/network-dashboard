...
class GetPortChannelNxosFnaParser(BaseParser):
    """
    Parser for get_port_channel_nxos_fna API response.
    ...
    Example after filling in:
        ...
        class GetPortChannelNxosFnaParser(BaseParser[FanStatusData]):
            device_type = DeviceType.HPE
            command = "get_port_channel_nxos_fna"
...
# Register parser
parser_registry.register(GetPortChannelNxosFnaParser())