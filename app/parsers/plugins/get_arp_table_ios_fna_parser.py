...
Endpoint: http://localhost:8001/switch/get_arp_table/10.1.1.2
...
class GetArpTableIosFnaParser(BaseParser):
    """
    ...
    Example after filling in:
        ...
        class GetArpTableIosFnaParser(BaseParser[FanStatusData]):
