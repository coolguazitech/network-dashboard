...
class GetAclNxosFnaParser(BaseParser):
    """
    Parser for get_acl_nxos_fna API response.
    ...
    Example after filling in:
        ...
        class GetAclNxosFnaParser(BaseParser[FanStatusData]):
            device_type = DeviceType.HPE
            command = "get_acl_nxos_fna"
...
# Register parser
parser_registry.register(GetAclNxosFnaParser())