...
Endpoint: http://localhost:8001/switch/get_neighbors/10.1.1.3
...
class GetUplinkNxosFnaParser(BaseParser):
    """
    Parser for get_uplink_nxos_fna API response.
    ...
    Example after filling in:
        ...
        class GetUplinkNxosFnaParser(BaseParser[FanStatusData]):
