...
Endpoint: http://localhost:8001/switch/get_arp_table/10.1.1.1
...
class GetArpTableHpeFnaParser(BaseParser):
    """
    Parser for get_arp_table_hpe_fna API response.
    ...
    Example after filling in:
        ...
        class GetArpTableHpeFnaParser(BaseParser[FanStatusData]):
