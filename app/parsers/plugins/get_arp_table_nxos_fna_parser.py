...
Endpoint: http://localhost:8001/switch/get_arp_table/10.1.1.3
...
class GetArpTableNxosFnaParser(BaseParser):
    """
    Parser for get_arp_table_nxos_fna API response.
    ...
    Example after filling in:
        ...
        class GetArpTableNxosFnaParser(BaseParser[FanStatusData]):
