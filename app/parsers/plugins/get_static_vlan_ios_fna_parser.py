...
class GetStaticVlanIosFnaParser(BaseParser[InterfaceVlanData]):
    """
    Parser for get_static_vlan_ios_fna API response.
    ...
    command = "get_static_vlan_ios_fna"
...
# Register parser
parser_registry.register(GetStaticVlanIosFnaParser())