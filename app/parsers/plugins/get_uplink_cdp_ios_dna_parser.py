"""
Parser for 'get_uplink_cdp_ios_dna' API.
...
class GetUplinkCdpIosDnaParser(BaseParser[NeighborData]):
    """
    ...
    command = "get_uplink_cdp_ios_dna"
...
# Register parser
parser_registry.register(GetUplinkCdpIosDnaParser())
