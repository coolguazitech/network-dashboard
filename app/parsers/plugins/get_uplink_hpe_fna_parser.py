...
Endpoint: http://localhost:8001/switch/get_neighbors/10.1.1.1
...
class GetUplinkHpeFnaParser(BaseParser):
    """
    Parser for get_uplink_hpe_fna API response.
    ...
    Example after filling in:
        ...
        class GetUplinkHpeFnaParser(BaseParser[FanStatusData]):
