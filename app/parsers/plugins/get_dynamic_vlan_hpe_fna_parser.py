...
class GetDynamicVlanHpeFnaParser(BaseParser[InterfaceVlanData]):
    """
    Parser for get_dynamic_vlan_hpe_fna API response.
    ...
    command = "get_dynamic_vlan_hpe_fna"
...
# Register parser
parser_registry.register(GetDynamicVlanHpeFnaParser())