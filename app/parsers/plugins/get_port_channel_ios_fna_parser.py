...
class GetPortChannelIosFnaParser(BaseParser):
    """
    Parser for get_port_channel_ios_fna API response.
    ...
    Example after filling in:
        ...
        class GetPortChannelIosFnaParser(BaseParser[FanStatusData]):
            device_type = DeviceType.HPE
            command = "get_port_channel_ios_fna"
...
# Register parser
parser_registry.register(GetPortChannelIosFnaParser())