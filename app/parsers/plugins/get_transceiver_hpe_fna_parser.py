...
class GetTransceiverHpeFnaParser(BaseParser):
    """
    Parser for get_transceiver_hpe_fna API response.
    ...
    Example after filling in:
        ...
        class GetTransceiverHpeFnaParser(BaseParser[FanStatusData]):
