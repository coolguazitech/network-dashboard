...
Endpoint: http://localhost:8001/switch/get_error_count/10.1.1.3
...
class GetErrorCountNxosFnaParser(BaseParser):
    """
    ...
    Example after filling in:
        ...
        class GetErrorCountNxosFnaParser(BaseParser[FanStatusData]):
