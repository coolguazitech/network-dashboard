...
Endpoint: http://localhost:8001/switch/get_error_count/10.1.1.1
...
class GetErrorCountHpeFnaParser(BaseParser):
    """
    Parser for get_error_count_hpe_fna API response.
    ...
    Example after filling in:
        ...
        class GetErrorCountHpeFnaParser(BaseParser[FanStatusData]):
