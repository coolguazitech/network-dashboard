...
# HH3C-TRANSCEIVER-INFO-MIB — hh3cTransceiverInfoEntry (indexed by ifIndex)
HH3C_TRANSCEIVER_TEMPERATURE = "1.3.6.1.4.1.25506.2.70.1.1.1.15"
HH3C_TRANSCEIVER_VOLTAGE = "1.3.6.1.4.1.25506.2.70.1.1.1.16"
HH3C_TRANSCEIVER_BIAS = "1.3.6.1.4.1.25506.2.70.1.1.1.17"
HH3C_TRANSCEIVER_TX_POWER = "1.3.6.1.4.1.25506.2.70.1.1.1.9"    # hh3cTransceiverCurTXPower
HH3C_TRANSCEIVER_RX_POWER = "1.3.6.1.4.1.25506.2.70.1.1.1.12"   # hh3cTransceiverCurRXPower

# HH3C-TRANSCEIVER-INFO-MIB — hh3cTransceiverChannelEntry (indexed by ifIndex.channel)
HH3C_TRANSCEIVER_CHANNEL_TX_POWER = "1.3.6.1.4.1.25506.2.70.1.2.1.2"  # QSFP per-lane TX
HH3C_TRANSCEIVER_CHANNEL_RX_POWER = "1.3.6.1.4.1.25506.2.70.1.2.1.3"  # QSFP per-lane RX
